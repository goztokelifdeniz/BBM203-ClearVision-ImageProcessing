...
private:
    ...
    int width, height;
    int upper_tri_arr_size;
    int lower_tri_arr_size;
...
public:
    ...
    int get_upper_tri_arr_size() const;
    int get_lower_tri_arr_size() const;

    void set_upper_triangular(int *upper);
    void set_lower_triangular(int *lower);
    void set_width(int value);
    void set_height(int value);
    void set_upper_tri_arr_size();
    void set_lower_tri_arr_size();
};
